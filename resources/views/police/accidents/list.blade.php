    ...
    <div class="row">
        <div class="col-lg-24">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                    <a href="{{ url('police/accidents/add')}}" class="btn btn-primary">Add New Accidents</a>
                     </h5>
                     <table class="table datatable">
                        ...
                        @foreach($getRecord as $value)
                            ...
                            <td>{{$value->victim_name}}</td>
                                ...
                                <td>
                                        <div class="btn-group">
                                            <a href="{{url('police/accidents/edit/'.$value->id)}}" class="btn btn-sm btn-primary">Edit</a>
