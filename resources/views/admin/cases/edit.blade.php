        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action=" {{ url('admin/cases/update/'.$cases->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field()}}
                        ...
                        <div class="row mb-3">
                            ...
                            <select name="crime" id="" class="form-control" required>
                                    ...
                                    <option {{ ($value->id == $cases->crime) ? 'selected' : '' }} value="{{ $value->id}}">{{ $value->crime_type}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
